...
const indiaData = {
    ...
    flightSearches: {
        '2023': [56338, 58446, 63092, 64681, 67902, 55258, 64796, 79677, 98022, 92417, 69100, 69478],
        '2024': [75924, 77060, 74757, 83158, 66969, 49995, 84185, 111273, 192068, 154350, 130464, 112140],
        '2025': [109664, 114462, 119797, 110386, 93263, 123051, 105427, null, null, null, null, null]
    },
    hotelGuests: {
        ...
        '2025': [46127, 27365, 36352, 33420, 37291, 36264, null, null, null, null, null, null]
    }
};
    ...
    flightsChart = new Chart(flightsCtx, {
        ...
        data: {
            ...
            datasets: [
                ...
                {
                    label: '2025',
                    data: indiaData.flightSearches['2025'],
                    borderColor: 'rgba(75, 192, 192, 1)',
                    backgroundColor: 'rgba(75, 192, 192, 0.1)',
                    borderWidth: 2,
                    fill: false
    ...
    hotelChart = new Chart(hotelCtx, {
        ...
        data: {
            ...
            datasets: [
                ...
                {
                    label: '2025',
                    data: indiaData.hotelGuests['2025'],
                    borderColor: 'rgba(75, 192, 192, 1)',
                    backgroundColor: 'rgba(75, 192, 192, 0.1)',
                    borderWidth: 2,
                    fill: false
